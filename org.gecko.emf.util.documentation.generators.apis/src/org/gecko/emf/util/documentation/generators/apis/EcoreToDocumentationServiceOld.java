...
@ProviderType
public interface EcoreToDocumentationServiceOld{
	
//	TODO as input we get already an EPackage or an EClass and it returns an OutputStream

	public static final String ECORE_FILE_EXTENSION = ".ecore";
	public static final Logger LOGGER = Logger.getLogger(EcoreToDocumentationServiceOld.class.getName());
	
	String getOutputFileExtension();
	String getOutputFolder(EcoreToDocumentationOptions mode);
	void doGenerateDocumentation(Path ecoreFilePath, EcoreToDocumentationOptions mode);
	...
	default void ecoreToDocumentation(String ecoreFilePath, EcoreToDocumentationOptions mode) {
	...
	default void generateOutputFile(Path ecoreFilePath, CharSequence generatedCharSeq, EcoreToDocumentationOptions mode) {
