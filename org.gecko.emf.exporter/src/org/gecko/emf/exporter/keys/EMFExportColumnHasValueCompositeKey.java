...
/**
 * Composite key used in lookup index for storing information if specific column has value.
 * 
...
public class EMFExportColumnHasValueCompositeKey {
	...
	public EMFExportColumnHasValueCompositeKey(String matrixName, String columnHeaderName) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EMFExportColumnHasValueCompositeKey other = (EMFExportColumnHasValueCompositeKey) obj;
