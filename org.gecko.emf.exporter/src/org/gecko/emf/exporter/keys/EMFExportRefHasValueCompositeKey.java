...
/**
 * Composite key used in lookup index for storing information if specific one-to-one reference has value.
 * 
 * @author Michal H. Siemaszko
 */
public class EMFExportRefHasValueCompositeKey {
	private final String matrixName;
	private final String columnHeaderName;	
	private final String refMatrixName;
	private final String refColumnHeaderName;
	
	public EMFExportRefHasValueCompositeKey(String matrixName, String columnHeaderName, String refMatrixName,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EMFExportRefHasValueCompositeKey other = (EMFExportRefHasValueCompositeKey) obj;
